...
export const userRoleEnum = pgEnum('user_role', ['owner', 'admin', 'client_services', 'specialty_skills', 'partner_admin', 'partner_contributor', 'partner_viewer', 'client_editor', 'client_viewer']);
