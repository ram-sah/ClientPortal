...
export default function NewsMonitoring() {
  ...
  const newsItem = {
    title: "Lead Generation for New Bookkeepers",
    url: "https://www.accountingweb.co.uk/community/industry-insights/lead-generation-for-new-bookkeepers",
    ...
    engagementScore: 87,
    totalScore: 97,
    weeklyTrendTag: "B2B Marketing Strategies",
    recommendedActions: "Highlight successful B2B marketing examples in upcoming communications",
    contentType: "Public Relations"
  };
  ...
  return (
    <AppLayout title="News Monitoring" subtitle={`Last updated: ${currentTime}`}>
